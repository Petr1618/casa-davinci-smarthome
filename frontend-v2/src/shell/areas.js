...
export const AREAS = [
  ...
  { id: 'garaz',       label: 'Garáž',              accent: '#9aa0a6', accentSoft: 'rgba(154,160,166,0.06)', comingSoon: false,
    blurb: 'Garážová vrata na impuls přes Shelly, výhledově čidlo polohy, nabíjení EV a přítomnost auta.' },

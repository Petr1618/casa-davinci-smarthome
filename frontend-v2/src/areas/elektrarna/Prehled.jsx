// =============================================================================
// Elektrárna · Přehled — the overview section (mockup screen: KPI strip →
// energy-flow scene → grid-3 detail cards). Extracted 1:1 from the previous
// single-screen Elektrarna; receives the live snapshot from the parent.
// =============================================================================
...
export default function Prehled({ data }) {
  const {
